...
from src.controllers.chef_profile_controller import chef_profile_blueprint
from src.controllers.recipe_controller import recipe_blueprint
...
def create_app():
    ...
    logger = get_logger("chef_service")
    ...
    def health():
        return success_response(
            ...
            "Chef service is healthy",
        )

    app.register_blueprint(chef_profile_blueprint)
